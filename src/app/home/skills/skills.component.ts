...
export class SkillsComponent implements OnInit {
  skillset = [
    {name: 'Front-end technologies', tech: ['HTML', ' CSS', ' JavaSript', ' JQuery', ' Angular 2+', ' AngularJS', ' Bootstrap', ' PHP', ' Laravel', ' Sightly']},
    {name: 'Programming Languages', tech: ['C', ' Python', ' C++', ' Java', ' Android', ' OpenCV', ' Adobe Experience Manager(AEM)']},
    {name: 'Other Development', tech: ['Linux Kernel', ' Bash Scripting', ' Device Driver Implementation']},
